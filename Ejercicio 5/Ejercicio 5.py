...
class Paciente:
    ...
    def verVisita(self,f):
        return self.__visitas.get(f) #Metodo get de los diccionarios, si la fecha no esta arroja un none
...
class Sistema:
    ...
    def verificarExiste(self,c):
        return c in self.__pacientes #Si fuera una lista se hace un ciclo 
        ...
        if valor == 1: 
            ...
            if sis.verificarExiste(cedula) == True:
                ...
                for i in range(0,numVis):
                    ...
                    ind = v.verIndice() #Como Indice ya esta en la clase visita no se usa la linea de código 187
            ...
            if sis.verificarExiste(cedula) == True:
                pac = sis.recuperaPac(cedula) #ver el paciente 
            ...
            if sis.verificarExiste(cedula) == True:
                ...
                archivo = open(f"Paciente {p.verNombre()}.txt",'w') #abrir un archivo txt 
